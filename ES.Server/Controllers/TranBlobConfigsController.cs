...
namespace ES.Server.Controllers
{
    public class TranBlobConfigsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Guid,SourceTableName,TargetTableName,ColName,Sort,Direct,MaxCount,Cstamp,Sstamp,TMstamp,CreatedBy,CreatedTime")] TranBlobConfig tranBlobConfig)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Guid,TableName,ColName,Sort,Direct,MaxCount,Cstamp,Sstamp,TMstamp,CreatedBy,CreatedTime")] TranBlobConfig tranBlobConfig)
        {
            if (ModelState.IsValid)
            {
