...
namespace ES.Client.ServiceReference {
    ...
    public partial class GetRequestBody {
        ...
        public GetRequestBody(string tranferNo, string clientCode, string varifyCode, long lastTimeStamp, int rowCount, string configGuid, ES.Client.ServiceReference.ArrayOfAnyType paras) {
    ...
    public partial class TransferSoapClient : System.ServiceModel.ClientBase<ES.Client.ServiceReference.TransferSoap>, ES.Client.ServiceReference.TransferSoap {
        ...
        public ES.Client.ServiceReference.ResponseData Get(string tranferNo, string clientCode, string varifyCode, long lastTimeStamp, int rowCount, string configGuid, ES.Client.ServiceReference.ArrayOfAnyType paras) {
